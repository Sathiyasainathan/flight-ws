...
public interface PriceDao
{
    ...
    /**
     * Loads an instance of org.iesc.flightws.domain.Price from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link org.iesc.flightws.domain.Price}.
     *
    ...
    /**
     * Creates an instance of org.iesc.flightws.domain.Price and adds it to the persistent store.
     */
    public org.iesc.flightws.domain.Price create(org.iesc.flightws.domain.Price price);

    /**
     * <p>
     * Does the same thing as {@link #create(org.iesc.flightws.domain.Price)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, org.iesc.flightws.domain.Price price);

    /**
     * Creates a new instance of org.iesc.flightws.domain.Price and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of org.iesc.flightws.domain.Price
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>org.iesc.flightws.domain.Price</code>
     * instance from <strong>all</strong> attributes and adds it to
     * the persistent store.
     * </p>
     */
    public org.iesc.flightws.domain.Price create(
        java.lang.Long passengerType,
        java.lang.Double price);

    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.Long, java.lang.Double)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>price</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of org.iesc.flightws.domain.Price from the persistent store.
     */
    public void remove(org.iesc.flightws.domain.Price price);

    /**
     * Removes the instance of org.iesc.flightws.domain.Price having the given
