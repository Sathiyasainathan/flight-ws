    ...
    implements org.iesc.flightws.service.FlightService
{
    ...
    public org.iesc.flightws.vo.FlightwsStubVO stubWebmethod()
    {
        try
        {
            return this.handleStubWebmethod();
        }
        catch (Throwable th)
        {
            throw new org.iesc.flightws.service.FlightServiceException(
                "Error performing 'org.iesc.flightws.service.FlightService.stubWebmethod()' --> " + th,
                th);
        }
    }

     /**
      * Performs the core logic for {@link #stubWebmethod()}
      */
    protected abstract org.iesc.flightws.vo.FlightwsStubVO handleStubWebmethod()
