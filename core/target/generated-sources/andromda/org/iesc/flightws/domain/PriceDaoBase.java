 ...
 */
public abstract class PriceDaoBase
    ...
    implements org.iesc.flightws.domain.PriceDao
{
    ...
    public java.lang.Object load(final int transform, final java.lang.Long id)
    {
        if (id == null)
        {
            throw new IllegalArgumentException(
                "Price.load - 'id' can not be null");
        }
        final java.lang.Object entity = this.getHibernateTemplate().get(org.iesc.flightws.domain.PriceImpl.class, id);
    ...
    public java.util.Collection loadAll(final int transform, final int pageNumber, final int pageSize)
    {
        try
        {
            final org.hibernate.Criteria criteria = this.getSession(false).createCriteria(org.iesc.flightws.domain.PriceImpl.class);
    ...
    public java.lang.Object create(final int transform, final org.iesc.flightws.domain.Price price)
    {
        ...
        {
            throw new IllegalArgumentException(
                "Price.create - 'price' can not be null");
        }
    ...
    public java.util.Collection create(final int transform, final java.util.Collection entities)
    {
        ...
        {
            throw new IllegalArgumentException(
                "Price.create - 'entities' can not be null");
        }
    ...
    public void update(org.iesc.flightws.domain.Price price)
    {
        ...
        {
            throw new IllegalArgumentException(
                "Price.update - 'price' can not be null");
        }
    ...
    public void update(final java.util.Collection entities)
    {
        ...
        {
            throw new IllegalArgumentException(
                "Price.update - 'entities' can not be null");
        }
        this.getHibernateTemplate().execute(
            new org.springframework.orm.hibernate3.HibernateCallback()
            {
    ...
    public void remove(org.iesc.flightws.domain.Price price)
    {
        ...
        {
            throw new IllegalArgumentException(
                "Price.remove - 'price' can not be null");
        }
    ...
    public void remove(java.lang.Long id)
    {
        ...
        {
            throw new IllegalArgumentException(
                "Price.remove - 'id' can not be null");
        }
    ...
    public void remove(java.util.Collection entities)
    {
        ...
        {
            throw new IllegalArgumentException(
                "Price.remove - 'entities' can not be null");
        }
